...
export const qKotlinMultiObjectVarAssignment = qKotliMultiObjectExpr(
  qKotliMultiObjectExpr(qKotliMultiObjectExpr(qKotlinSingleObjectVarAssignment))
).handler(cleanupTempVars);
